            ...
            <div class="mb-6">
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-600">Update informasi promo</p>
                    </div>
                </div>
            </div>
                ...
                <form action="{{ route('admin.promo.update', $promo) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" id="description" rows="4" required
                                  class="w-full rounded-lg border-gray-300 shadow-sm focus:border-wood-500 focus:ring-wood-500 @error('description') border-red-500 @enderror">{{ old('description', $promo->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" name="discount_value" id="discount_value" value="{{ old('discount_value', $promo->discount_value) }}" min="0" step="0.01" required
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="date" name="valid_from" id="valid_from" value="{{ old('valid_from', $promo->valid_from->format('Y-m-d')) }}" required
                        ...
                        <div>
                            ...
                            <input type="date" name="valid_until" id="valid_until" value="{{ old('valid_until', $promo->valid_until->format('Y-m-d')) }}" required
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="terms" id="terms" rows="4"
                                  class="w-full rounded-lg border-gray-300 shadow-sm focus:border-wood-500 focus:ring-wood-500 @error('terms') border-red-500 @enderror">{{ old('terms', $promo->terms) }}</textarea>
                        @error('terms')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
