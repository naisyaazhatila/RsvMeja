    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-600">Update informasi testimoni</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <form action="{{ route('admin.testimoni.update', $testimonial) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="testimonial" id="testimonial" rows="6" required
                                  class="w-full rounded-lg border-gray-300 shadow-sm focus:border-wood-500 focus:ring-wood-500 @error('testimonial') border-red-500 @enderror">{{ old('testimonial', $testimonial->comment) }}</textarea>
                        @error('testimonial')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
