        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600">Kelola testimoni pelanggan</p>
                </div>
                <a href="{{ route('admin.testimoni.create') }}" class="inline-flex items-center px-4 py-2 bg-wood-600 hover:bg-wood-700 text-white font-semibold rounded-lg transition duration-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($testimonials as $testimonial)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900 line-clamp-2 max-w-md">{{ $testimonial->comment }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    <div class="text-gray-400">
                                        ...
                                        <p class="mt-2 text-sm text-gray-500">Belum ada testimoni</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
