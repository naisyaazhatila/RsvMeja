...
<head>
    ...
    <title>{{ $title }} - {{ setting('restaurant_name', 'Restaurant') }}</title>
            ...
            <div class="flex items-center justify-between h-16 px-6 bg-bark-900 border-b border-wood-500/20">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-cream-200">{{ setting('restaurant_name', 'Asya\'s Kitchen') }}</p>
                    </div>
                </div>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="flex items-center justify-between h-16 px-6 bg-white border-b border-gray-200">
                ...
                <div class="flex-1 flex items-center justify-between lg:justify-end">
                    <h2 class="text-xl font-heading font-bold text-bark-900 lg:hidden">{{ $title }}</h2>
